...
intern void platform_free(void *block)
{
    free(block);
}
...
intern void mem_free_list_init(mem_store *mem)
{
...
intern void mem_free_list_term(mem_store *mem)
{}

intern void mem_pool_init(mem_store *mem)
{
...
intern void mem_pool_term(mem_store *mem)
{}

intern void mem_stack_init(mem_store *mem)
{
    mem->mstack.offset = 0;
}

intern void mem_stack_term(mem_store *mem)
{}

intern void mem_linear_init(mem_store *mem)
{
    mem->mlin.offset = 0;
}

intern void mem_linear_term(mem_store *mem)
{}
...
void *ns_alloc(mem_store *mem, sizet size, sizet alignment)
{
    ...
    case (MEM_ALLOC_POOL):
        nsassert(size == mem->mpool.chunk_size);
